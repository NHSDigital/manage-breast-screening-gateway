...
var miRoleAssignments = [
  ...
  }
  {
    ...
    description: 'Role Based Access Control Administrator access to subscription. Can assign Storage Blob Data Contributor, Storage Queue Data Contributor, and Azure Connected Machine Onboarding roles.'
