...
class NCreate:
    ...
    def call(self, event: Event) -> tuple[int, Dataset | None]:
        ...
        try:
            ...
            if (
                hasattr(attr_list, "ScheduledStepAttributesSequence")
                and len(attr_list.ScheduledStepAttributesSequence) > 0
            ):
            ...
            logger.info(
                f"MPPS N-CREATE: Started procedure for Accession={accession_number}, "
