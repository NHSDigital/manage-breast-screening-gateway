...
class TestUploadProcessor:
    ...
    def test_upload_instance_success(self, processor, mock_pacs_storage, mock_mwl_storage, mock_uploader):
        ...
        mock_pacs_storage.mark_upload_started.assert_called_once_with("1.2.3.4")
        mock_pacs_storage.mark_upload_complete.assert_called_once_with("1.2.3.4")
        mock_uploader.upload_dicom.assert_called_once_with("1.2.3.4", b"dicom data", "ACTION123")
